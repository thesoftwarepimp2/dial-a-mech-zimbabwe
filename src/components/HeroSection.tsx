          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mb-8">
            <div className="text-center lg:text-left">
              <h1 className="text-4xl lg:text-6xl font-bold mb-6 animate-fade-up">
                <span className="block text-yellow-300">Find a Mechanic</span>
            ...
            <div className="relative">
              <img 
                src="/lovable-uploads/5df0e592-8a27-4988-a74a-9c904fae48bf.png"
                alt="Vehicle in workshop getting fixed"
                className="w-full h-auto rounded-2xl shadow-2xl animate-fade-up"
              />
            </div>
          </div>
